        ...
        <div className="row justify-content-center">
          <div className="col-lg-6 col-md-8">
            <div className="login-card">
              ...
              <select className="form-control mb-3" name="department" value={formData.department} onChange={handleChange}>
              ...
              <select className="form-control mb-3" name="designation" value={formData.designation} onChange={handleChange}>
              ...
              <select className="form-control mb-3" name="employmentType" value={formData.employmentType} onChange={handleChange}>
